...
<div id="main_typegroup_list" class="easyui-layout" fit="true">
    <div region="center" style="padding: 1px;">
        <t:datagrid name="typeGridTree" title="common.data.dictionary" actionUrl="systemController.do?typeGroupGrid"
            ...
            <t:dgToolBar title="common.add.param" langArg="lang.dictionary.type" icon="fa fa-lg fa-plus" url="systemController.do?aouTypeGroup" funname="add"></t:dgToolBar>
            <%--<t:dgToolBar title="common.add.param" langArg="lang.dictionary.value" icon="icon-add" funname="typeGridTree_AddType"></t:dgToolBar>--%>
            <t:dgToolBar title="common.edit" icon="fa fa-lg fa-edit" url="systemController.do?aouTypeGroup" funname="update"></t:dgToolBar>
        </t:datagrid>
    </div>
</div>
