...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType">
    ...
    <fieldset class="step">
        ...
        <div class="form">
            ...
            <input name="typename" class="inputxt" value="${type.typename }" datatype="s1-50">
            <span class="Validform_checktip">字典名称在1~50位字符</span>
        </div>
        <div class="form">
            ...
            <span class="Validform_checktip">字典编码在1~50位字符</span>
        </div>
        <div class="form">
			<label class="Validform_label"> <t:mutiLang langKey="common.order"/>: </label> 
			<input name="sortnum" class="inputxt" value="${type.sortnum}" ></div>
		</div>
    </fieldset>
</t:formvalid>
</body>
