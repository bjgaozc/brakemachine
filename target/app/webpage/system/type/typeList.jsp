...
<div region="center" style="padding: 1px;"><t:datagrid name="${typegroup.typegroupcode}List" title="类型列表" actionUrl="systemController.do?typeGrid&typegroupid=${typegroup.id}" idField="id"
	...
	<t:dgToolBar title="${typegroup.typegroupname}录入" icon="fa fa-lg fa-plus" url="systemController.do?addorupdateType&typegroupid=${typegroup.id}" funname="add"></t:dgToolBar>
	<t:dgToolBar title="类别编辑" icon="fa fa-lg fa-edit" url="systemController.do?addorupdateType&typegroupid=${typegroup.id}" funname="update"></t:dgToolBar>
</t:datagrid></div>
</div>
