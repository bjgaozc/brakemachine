...
<div region="center" style="padding: 1px;">
    <t:datagrid name="iconList" title="icon.list" actionUrl="iconController.do?datagrid" idField="id">
        ...
        <t:dgToolBar title="common.add.param" langArg="common.icon" icon="fa fa-lg fa-plus" url="iconController.do?addorupdate" funname="add"></t:dgToolBar>
        <t:dgToolBar title="common.edit.param" langArg="common.icon" icon="fa fa-lg fa-edit" url="iconController.do?addorupdate" funname="update"></t:dgToolBar>
        <t:dgToolBar title="batch.generate.style" icon="fa fa-lg fa-edit" url="iconController.do?repair" funname="doSubmit"></t:dgToolBar>
    </t:datagrid>
</div>
</div>
