...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="mutiLangList" title="lang.maintain" actionUrl="mutiLangController.do?datagrid" 
      idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc" pageSize="20">
   <t:dgCol title="common.code" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="common.languagekey" field="langKey" query="true" extend="{style:'width:300px'}"></t:dgCol>
