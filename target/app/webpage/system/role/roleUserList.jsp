...
<t:datagrid name="roleUserList" title="common.operation"
	...
	<t:dgToolBar title="common.add.param" langArg="common.user" icon="fa fa-lg fa-plus" url="userController.do?addorupdate&roleId=${roleId}" funname="add"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user" icon="fa fa-lg fa-edit" url="userController.do?addorupdate&roleId=${roleId}" funname="update"></t:dgToolBar>
	<t:dgToolBar title="common.add.exist.user" icon="fa fa-lg fa-plus" url="roleController.do?goAddUserToRole&roleId=${roleId}" funname="add" width="500"></t:dgToolBar>
</t:datagrid>
