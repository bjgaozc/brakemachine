...
<div region="center" style="padding: 1px;"><%--functionController.do?functionGrid  --%>
    <t:datagrid name="functionList" title="menu.manage" actionUrl="appCommonController.do?functionGrid" idField="id" treegrid="true" pagination="false">
        ...
        <t:dgToolBar title="common.add.param" langArg="common.menu" icon="fa fa-lg fa-plus" url="functionController.do?addorupdate" funname="addFun"></t:dgToolBar>
        <t:dgToolBar title="common.edit.param" langArg="common.menu" icon="fa fa-lg fa-edit" url="functionController.do?addorupdate" funname="update"></t:dgToolBar>
    </t:datagrid>
</div>
</div>
<%--   update-start--Author:duanql  Date:20130619 for：操作按钮窗口显示控制--%>
