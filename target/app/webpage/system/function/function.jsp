...
<t:formvalid formid="formobj" layout="div" dialog="true" refresh="true" action="functionController.do?saveFunction">
	...
	<div class="form">
        ...
        <input name="functionName" class="inputxt" value="${function.functionName}" datatype="s4-100">
        <span class="Validform_checktip"> <t:mutiLang langKey="menuname.rang4to100"/> </span>
    </div>
    <div class="form">
	...
	<div class="form" id="funurl">
        ...
        <input name="functionUrl" class="inputxt" style="width: 400px;" value="${function.functionUrl}">
    </div>
    <div class="form">
