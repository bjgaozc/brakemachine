...
<t:datagrid name="departUserList" title="common.operation"
	...
	<t:dgToolBar title="common.add.param" langArg="common.user" icon="fa fa-lg fa-plus" url="userController.do?addorupdate&departid=${departid}" funname="add"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user" icon="fa fa-lg fa-edit" url="userController.do?addorupdate&departid=${departid}" funname="update"></t:dgToolBar>
    <%--update-start--Author:zhangguoming  Date:20140826 for：添加有客户--%>
	<t:dgToolBar title="common.add.exist.user" icon="fa fa-lg fa-plus" url="departController.do?goAddUserToOrg&orgId=${departid}" funname="add" width="500"></t:dgToolBar>
