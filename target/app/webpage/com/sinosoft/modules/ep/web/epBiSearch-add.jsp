...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="epBiSearchController.do?doAdd" tiptype="1">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						  	 <textarea style="width:98%;" class="inputxt" rows="6" id="seNote" name="seNote"></textarea>
							<span class="Validform_checktip"></span>
