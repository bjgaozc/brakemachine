...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","edialog"],parse:function(_2){
var aa=[];
...
_9d.bb.refresh.linkbutton({iconCls:(_9e.loading?"pagination-loading":"fa fa-refresh")});
}
};
...
$.fn.progressbar.defaults={width:"auto",height:25,value:0,text:"{value}%",onChange:function(_1bc,_1bd){
}};
})(jQuery);
(function($){
function init(_1be){
...
if(opts.collapsible){
$("<a class=\"panel-tool-collapse fa fa-caret-down\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
...
_254.panel({border:false,doSize:false,bodyCls:"edialog-content"});
return _254;
};
function _255(_256){
var opts=$.data(_256,"edialog").options;
var _257=$.data(_256,"edialog").contentPanel;
if(opts.toolbar){
if($.isArray(opts.toolbar)){
$(_256).find("div.edialog-toolbar").remove();
var _258=$("<div class=\"edialog-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").prependTo(_256);
var tr=_258.find("tr");
...
$(opts.toolbar).addClass("edialog-toolbar").prependTo(_256);
$(opts.toolbar).show();
}
}else{
$(_256).find("div.edialog-toolbar").remove();
...
$(_256).find("div.edialog-button").remove();
var _259=$("<div class=\"edialog-button\"></div>").appendTo(_256);
...
$(opts.buttons).addClass("edialog-button").appendTo(_256);
$(opts.buttons).show();
}
}else{
$(_256).find("div.edialog-button").remove();
...
_257.panel("resize",{width:_25f.width(),height:(_25e=="auto")?"auto":_25f.height()-_25f.children("div.edialog-toolbar")._outerHeight()-_25f.children("div.edialog-button")._outerHeight()});
if(opts.onResize){
...
var _262=$.data(_261,"edialog").contentPanel;
_262.panel("refresh",href);
};
$.fn.edialog=function(_263,_264){
if(typeof _263=="string"){
var _265=$.fn.edialog.methods[_263];
if(_265){
...
_263=_263||{};
return this.each(function(){
var _266=$.data(this,"edialog");
if(_266){
$.extend(_266.options,_263);
}else{
$.data(this,"edialog",{options:$.extend({},$.fn.edialog.defaults,$.fn.edialog.parseOptions(this),_263),contentPanel:_252(this)});
}
_255(this);
});
};
$.fn.edialog.methods={options:function(jq){
var _267=$.data(jq[0],"edialog").options;
...
var _269=$.data(jq[0],"edialog").contentPanel;
return _267;
},edialog:function(jq){
...
$.fn.edialog.parseOptions=function(_26a){
...
switch(icon){
case "error":
_278="<div class=\"messager-icon red fa fa-lg fa-times-circle\"></div>"+_278;
break;
case "info":
_278="<div class=\"messager-icon blue fa fa-lg fa-info-circle\"></div>"+_278;
break;
case "question":
_278="<div class=\"messager-icon blue fa fa-lg fa-question-circle\"></div>"+_278;
break;
case "warning":
_278="<div class=\"messager-icon orange fa fa-lg fa-warning\"></div>"+_278;
break;
}
...
var _27b="<div class=\"messager-icon blue fa fa-lg fa-question-circle\"></div>"+"<div>"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _27c={};
...
var _27e="<div class=\"messager-icon blue fa fa-lg fa-question-circle\"></div>"+"<div>"+msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input form-control\" type=\"text\"/></div>";
var _27f={};
...
_2a8.find(".fa-angle-double-up").removeClass("fa-angle-double-down");
},onExpand:function(){
if(_2a7.onExpand){
...
_2a9.find(".fa-angle-double-up").addClass("fa-angle-double-down");
},onCollapse:function(){
if(_2a7.onCollapse){
...
if(_2e0>_2e1){
_2dd.add(_2de).show()._outerHeight(_2df).css("lineHeight",_2df+"px");
...
$("<div class=\"tabs-header\">"+"<div class=\"tabs-scroller-left fa fa-lg fa-angle-double-left\"></div>"+"<div class=\"tabs-scroller-right fa fa-lg fa-angle-double-right\"></div>"+"<div class=\"tabs-wrap\">"+"<ul class=\"tabs\"></ul>"+"</div>"+"</div>").prependTo(_2f5);
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:34,selected:0,showHeader:true,plain:false,fit:false,border:true,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_345){
...
var _fa="fa fa-lg",_369="fa-angle-double-"+_368[dir];
var t=tool.children("a."+_369);
if(!t.length){
t=$("<a href=\"javascript:void(0)\"></a>").addClass(_fa).addClass(_369).appendTo(tool);
...
if(dir=="west"){
icon="fa fa-lg fa-angle-double-right";
}else{
if(dir=="north"){
icon="fa fa-lg fa-angle-double-down";
}else{
if(dir=="south"){
icon="fa fa-lg fa-angle-double-up";
}
}
}
}
...
$(this).closest("div.menu-item")._outerHeight($(this)._outerHeight()+12);
});
_3a6+=65;
...
$.fn.menubutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,menu:null,duration:100,cls:{btn1:"m-btn-active",btn2:"m-btn-plain-active",arrow:"m-btn-downarrow fa fa-caret-down",trigger:"m-btn"}});
})(jQuery);
(function($){
function init(_3e4){
...
$.fn.splitbutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,menu:null,duration:100,cls:{btn1:"s-btn-active",btn2:"s-btn-plain-active",arrow:"s-btn-downarrow fa fa-caret-down",trigger:"s-btn-downarrow"}});
})(jQuery);
(function($){
function init(_3ec){
...
$("<span><span class=\"searchbox-button fa fa-search\"></span></span>").appendTo(span);
...
$.fn.searchbox.defaults={width:"auto",height:25,prompt:"",value:"",menu:null,searcher:function(_408,name){
}};
})(jQuery);
(function($){
function init(_409){
...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"这是必填项。",invalidMessage:null,tipPosition:"bottom",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
$.fn.spinner.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:25,deltaX:19,value:"",min:null,max:null,increment:1,editable:true,disabled:false,spin:function(down){
},onSpinUp:function(){
},onSpinDown:function(){
}});
})(jQuery);
...
var _7f9=_7f6.find(".combo-arrow.fa.fa-chevron-down");
...
_7f9._outerHeight(_7f6.height()+2);
...
var span=$("<span class=\"combo\">"+"<input type=\"text\" class=\"combo-text\" autocomplete=\"off\">"+"<span><span class=\"combo-arrow fa fa-chevron-down\"></span></span>"+"<input type=\"hidden\" class=\"combo-value\">"+"</span>").insertAfter(_7fb);
...
var _810=_80e.find(".combo-arrow.fa.fa-chevron-down");
...
$.fn.combo.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:25,panelWidth:null,panelHeight:200,multiple:false,selectOnNavigation:true,separator:",",editable:true,disabled:false,readonly:false,hasDownArrow:true,value:"",delay:200,deltaX:19,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
$.fn.combogrid.defaults=$.extend({},$.fn.combo.defaults,$.fn.datagrid.defaults,{width:"auto",height:25,loadMsg:null,idField:null,textField:null,mode:"local",keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
_8de(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_8ef){
...
(function($){
function init(_918){
var _919=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle blue fa fa-lg fa-circle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_918);
var t=$(_918);
