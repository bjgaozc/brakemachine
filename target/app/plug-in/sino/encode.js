 ...
 * 
 * 前台:encode.encode64(''); 
 * 后台:DecodeUtil.decodeAndReturnStr('');
 * 
 * var a = encode.encrypt("index","123");
 * console.log(a);
 * console.log(encode.decrypt("6541536e2203c7db49","123"));
 * 
 * @author cmh
...
var encode = {
	...
	encode64: function(input) {
		...
		do {
			...
			output = output + encode.keyStr.charAt(enc1) + encode.keyStr.charAt(enc2) + encode.keyStr.charAt(enc3) + encode.keyStr.charAt(enc4);
			chr1 = chr2 = chr3 = "";
			enc1 = enc2 = enc3 = enc4 = "";
