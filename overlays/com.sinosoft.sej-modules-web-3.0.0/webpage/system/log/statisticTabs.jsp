...
<script type="text/javascript" src="plug-in/highcharts/js/highcharts.src.js"></script>
<script type="text/javascript" src="plug-in/highcharts/js/modules/exporting.src.js"></script>
