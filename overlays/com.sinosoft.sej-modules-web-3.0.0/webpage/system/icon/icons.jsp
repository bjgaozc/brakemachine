...
<t:formvalid formid="formobj" layout="div" dialog="true" action="iconController.do?saveOrUpdateIcon">
    ...
    <div class="form">
        <label class="Validform_label"><t:mutiLang langKey="common.icon.style"/>: </label>
        <input name="iconClas" id="iconClas" value="${icon.iconClas}" class="inputxt">
        <span class="Validform_checktip">例如：fa fa-list no-bg</span>
    </div>
    <div class="form">
        <label class="Validform_label"><t:mutiLang langKey="common.icon.type"/>: </label>
        <input name="extend" id="extend" value="${icon.extend}" class="inputxt">
        <span class="Validform_checktip">例如：fontawesome</span>
    </div>
	<div class="form">
        <label class="Validform_label"> <t:mutiLang langKey="common.icon.type"/>: </label>
