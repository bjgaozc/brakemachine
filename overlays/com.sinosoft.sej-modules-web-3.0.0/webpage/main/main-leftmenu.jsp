...
<body id="mainLayoutId" class="easyui-layout" scroll="no">
	...
	<%--左侧--%>
	<div class="west" data-options="region:'west',split:true"
		href="loginController.do?left" title="<i class='fa fa-th'></i>导航菜单"></div>
	<%--中间--%>
	<div class="center" id="mainPanle" region="center"
		data-options="onResize:function(w,h){refreshIndexTab();}">
