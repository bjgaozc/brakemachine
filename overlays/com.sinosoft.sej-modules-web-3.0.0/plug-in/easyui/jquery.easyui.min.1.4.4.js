...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","switchbutton","progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","edialog","form"],parse:function(_2){
var aa=[];
...
_be.bb.refresh.linkbutton({iconCls:(_bf.loading?"pagination-loading":"fa fa-refresh")});
}
};
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {total} items",nav:{first:{iconCls:"fa fa-step-backward",handler:function(){
var _ce=$(this).pagination("options");
if(_ce.pageNumber>1){
$(this).pagination("select",1);
}
}},prev:{iconCls:"fa fa-chevron-left",handler:function(){
var _cf=$(this).pagination("options");
if(_cf.pageNumber>1){
$(this).pagination("select",_cf.pageNumber-1);
}
}},next:{iconCls:"fa fa-chevron-right",handler:function(){
...
}},last:{iconCls:"fa fa-step-forward",handler:function(){
...
_fe.removeClass("tree-dnd-yes tree-dnd-no").addClass(_fd?"tree-dnd-yes blue fa fa-lg fa-check":"tree-dnd-no red fa fa-lg fa-remove");
};
...
nt.empty();
var _193=$("<input class=\"tree-editor form-control\">").appendTo(nt);
_193.val(node.text).focus();
_193.width(_192+20);
_193.height(document.compatMode=="CSS1Compat"?(35-(_193.outerHeight()-_193.height())):35);
...
if(opts.collapsible){
_227(tool,"panel-tool-collapse fa fa-caret-down",function(){
...
if(opts.minimizable){
_227(tool,"panel-tool-min fa fa-sm fa-window-minimize",function(){
_24b(_21e);
});
}
if(opts.maximizable){
_227(tool,"panel-tool-max fa fa-sm fa-window-maximize",function(){
...
if(opts.closable){
_227(tool,"panel-tool-close fa fa-remove",function(){
_239(_21e);
});
}
}
...
tool.removeClass("fa-caret-down").addClass("panel-tool-expand fa-caret-up");
if(_243==true){
...
tool.removeClass("panel-tool-expand fa-caret-up").addClass("fa-caret-down");
if(_247==true){
...
tool.addClass("panel-tool-restore fa-window-restore").removeClass("fa-window-maximize");
...
_250.show();
tool.removeClass("panel-tool-restore fa-window-restore").addClass("fa-window-maximize");
...
(function($){
function _292(_293){
var opts=$.data(_293,"edialog").options;
opts.inited=false;
...
$(_293).siblings("div.edialog-toolbar").remove();
var _294=$("<div class=\"edialog-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").appendTo(win);
var tr=_294.find("tr");
for(var i=0;i<opts.toolbar.length;i++){
var btn=opts.toolbar[i];
if(btn=="-"){
$("<td><div class=\"edialog-tool-separator\"></div></td>").appendTo(tr);
}else{
var td=$("<td></td>").appendTo(tr);
...
$(opts.toolbar).addClass("edialog-toolbar").appendTo(win);
$(opts.toolbar).show();
}
}else{
$(_293).siblings("div.edialog-toolbar").remove();
...
$(_293).siblings("div.edialog-button").remove();
var _295=$("<div class=\"edialog-button\"></div>").appendTo(win);
...
$(opts.buttons).addClass("edialog-button").appendTo(win);
$(opts.buttons).show();
}
}else{
$(_293).siblings("div.edialog-button").remove();
...
var t=$(_299);
var opts=t.edialog("options");
var _29b=opts.noheader;
var tb=t.siblings(".edialog-toolbar");
var bb=t.siblings(".edialog-button");
tb.insertBefore(_299).css({position:"relative",borderTopWidth:(_29b?1:1),top:(_29b?tb.length:0)});
...
$.fn.edialog=function(_2a0,_2a1){
if(typeof _2a0=="string"){
var _2a2=$.fn.edialog.methods[_2a0];
if(_2a2){
...
_2a0=_2a0||{};
return this.each(function(){
var _2a3=$.data(this,"edialog");
if(_2a3){
$.extend(_2a3.options,_2a0);
}else{
$.data(this,"edialog",{options:$.extend({},$.fn.edialog.defaults,$.fn.edialog.parseOptions(this),_2a0)});
}
_292(this);
});
};
$.fn.edialog.methods={options:function(jq){
var _2a4=$.data(jq[0],"edialog").options;
...
$.fn.edialog.parseOptions=function(_2a6){
var t=$(_2a6);
return $.extend({},$.fn.window.parseOptions(_2a6),$.parser.parseOptions(_2a6,["toolbar","buttons"]),{toolbar:(t.children(".edialog-toolbar").length?t.children(".edialog-toolbar").removeClass("edialog-toolbar"):undefined),buttons:(t.children(".edialog-button").length?t.children(".edialog-button").removeClass("edialog-button"):undefined)});
};
$.fn.edialog.defaults=$.extend({},$.fn.window.defaults,{title:"New Edialog",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
function _2a7(){
...
dlg.edialog($.extend({},opts,{noheader:(opts.title?false:true),openAnimation:(opts.showType),closeAnimation:(opts.showType=="show"?"hide":opts.showType),openDuration:opts.showSpeed,closeDuration:opts.showSpeed,onOpen:function(){
dlg.edialog("edialog").hover(function(){
if(opts.timer){
...
if(dlg.length&&dlg.data("edialog")){
dlg.edialog("close");
}
},opts.timeout);
}
...
dlg.edialog("edialog").css(opts.style);
dlg.edialog("open");
return dlg;
};
function _2ad(_2ae){
_2a7();
var dlg=$("<div class=\"messager-body\"></div>").appendTo("body");
dlg.edialog($.extend({},_2ae,{noheader:(_2ae.title?false:true),onClose:function(){
_2a9();
if(_2ae.onClose){
...
var win=dlg.edialog("edialog").addClass("messager-window");
win.find(".edialog-button").addClass("messager-button").find("a:first").focus();
return dlg;
};
function _2af(dlg,_2b0){
dlg.edialog("close");
dlg.edialog("options").fn(_2b0);
};
...
switch(opts.icon){
    case "error":
        opts.icon="red fa fa-lg fa-times-circle";
        break;
    case "info":
        opts.icon="blue fa fa-lg fa-info-circle";
        break;
    case "question":
        opts.icon="blue fa fa-lg fa-question-circle";
        break;
    case "warning":
        opts.icon="orange fa fa-lg fa-warning";
        break;
}
...
opts=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon blue fa fa-lg fa-question-circle\"></div>"+"<div>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
_2af(dlg,true);
...
opts=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon blue fa fa-lg fa-question-circle\"></div>"+"<div>"+opts.msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input form-control\" type=\"text\"/></div>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
...
$.messager.defaults=$.extend({},$.fn.edialog.defaults,{ok:"确定",cancel:"取消",width:300,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
}});
})(jQuery);
(function($){
...
_2dd.find(".fa-angle-double-up").removeClass("fa-angle-double-down");
},onExpand:function(){
if(_2dc.onExpand){
...
_2de.find(".fa-angle-double-up").addClass("fa-angle-double-down");
},onCollapse:function(){
if(_2dc.onCollapse){
...
var t=$("<a href=\"javascript:void(0)\"></a>").addClass("fa fa-lg fa-angle-double-up ").appendTo(tool);
...
if(_319>_31a){
_316.add(_317).show()._outerHeight(_318).css("lineHeight",(_318-2)+"px");
...
$("<div class=\"tabs-header\">"+"<div class=\"tabs-scroller-left fa fa-lg fa-angle-double-left\"></div>"+"<div class=\"tabs-scroller-right fa fa-lg fa-angle-double-right\"></div>"+"<div class=\"tabs-wrap\">"+"<ul class=\"tabs\"></ul>"+"</div>"+"</div>").prependTo(_332);
...
$("<a href=\"javascript:void(0)\" class=\"tabs-close fa fa-remove\"></a>").appendTo(tab);
}else{
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:34,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_389){
...
var _fa="fa fa-lg",_3ae="fa-angle-double-"+_3ad[dir];
var t=tool.children("a."+_3ae);
if(!t.length){
t=$("<a href=\"javascript:void(0)\"></a>").addClass(_fa).addClass(_3ae).appendTo(tool);
...
var icon="fa fa-lg fa-angle-double-"+_3c5[dir];
...
if(item[0].submenu){
$("<div class=\"menu-rightarrow fa fa-caret-right\"></div>").appendTo(item);
}
_3fd(_3f4,item);
}
});
...
$(this).find(".menu-text").css({height:$(this).css("height"),lineHeight:$(this).css("height")});
});
...
$.fn.menu.defaults={zIndex:110000,left:0,top:0,alignTo:null,align:"left",minWidth:120,itemHeight:32,duration:100,hideOnUnhover:true,inline:false,fit:false,noline:false,onShow:function(){
},onHide:function(){
...
$.fn.menubutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,hasDownArrow:true,menu:null,menuAlign:"left",duration:100,cls:{btn1:"m-btn-active",btn2:"m-btn-plain-active",arrow:"m-btn-downarrow fa fa-caret-down",trigger:"m-btn"}});
})(jQuery);
(function($){
function init(_44b){
...
$.fn.splitbutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,menu:null,duration:100,cls:{btn1:"m-btn-active s-btn-active",btn2:"m-btn-plain-active s-btn-plain-active",arrow:"m-btn-downarrow fa fa-caret-down",trigger:"m-btn-line"}});
})(jQuery);
(function($){
function init(_453){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"这个是必填项",invalidMessage:null,tipPosition:"top",deltaX:0,novalidate:false,events:{focus:_488,blur:_48c,mouseenter:_490,mouseleave:_493,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请输入有效的电子邮件地址"},url:{validator:function(_4b3){
...
},message:"请输入有效网址"},length:{validator:function(_4b4,_4b5){
var len=$.trim(_4b4).length;
return len>=_4b5[0]&&len<=_4b5[1];
},message:"请输入{0}到{1}之间的值"},remote:{validator:function(_4b6,_4b7){
var data={};
data[_4b7[1]]=_4b6;
var _4b8=$.ajax({url:_4b7[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _4b8=="true";
},message:"请修正此字段"}},onBeforeValidate:function(){
...
_4ca.css({width:opts.iconWidth+"px",height:tb.height()+"px",lineHeight:tb.height()+"px"});
...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:32,prompt:"",value:"",type:"text",multiline:false,editable:true,disabled:false,readonly:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:18,buttonText:"",buttonIcon:null,buttonAlign:"right",inputEvents:{blur:function(e){
var t=$(e.data.target);
...
_509.push({iconCls:"searchbox-button fa fa-search",handler:function(e){
var t=$(e.data.target);
...
_590.append("<a href=\"javascript:void(0)\" class=\"spinner-arrow-up fa fa-caret-up\" tabindex=\"-1\"></a>");
_590.append("<a href=\"javascript:void(0)\" class=\"spinner-arrow-down fa fa-caret-down\" tabindex=\"-1\"></a>");
...
$(_743)._outerWidth(_744)._outerHeight(32);
}
}};
};
};
...
$(_75c)._outerWidth(_75d)._outerHeight(32);
}}});
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, 请稍等……",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_635(true),mouseout:_635(false),click:_63d,dblclick:_647,contextmenu:_64b},rowStyler:function(_7d9,_7da){
...
if(opts.hasDownArrow){
_95f.push({iconCls:"combo-arrow fa fa-chevron-down",handler:function(e){
_963(e.data.target);
}});
}
...
$.fn.combogrid.defaults=$.extend({},$.fn.combo.defaults,$.fn.datagrid.defaults,{height:32,loadMsg:null,idField:null,textField:null,unselectedValues:[],mappingRows:[],mode:"local",keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
_a4d(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_a62){
...
(function($){
function init(_a8d){
var _a8e=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle blue fa fa-lg fa-circle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_a8d);
var t=$(_a8d);
...
_aa1.html("<a href=\"javascript:void(0)\" class=\"slider-handle blue fa fa-lg fa-circle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_aa1.append("<a href=\"javascript:void(0)\" class=\"slider-handle blue fa fa-lg fa-circle\"></a>"+"<span class=\"slider-tip\"></span>");
}
